...
INSERT IGNORE INTO `quiz_difficulty_levels` (`difficulty_id`, `level_name`, `difficulty_value`, `description`) VALUES
...
INSERT INTO `quiz_questions` (`quiz_id`, `question_type`, `question_text`, `options`, `correct_answer`, `explanation`, `points`, `order_index`, `difficulty_id`) VALUES
